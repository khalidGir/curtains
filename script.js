...
const translations = {
  en: {
    ...
    text: {
      ...
      '.collection-card:nth-child(1) .collection-card-copy p': 'HERITAGE PATTERNS', '.collection-card:nth-child(1) h3': 'Heritage Sand', '.collection-card:nth-child(1) small': 'Feature rooms · Hotels',
      '.collection-card:nth-child(2) .collection-card-copy p': 'BLUE NILE', '.collection-card:nth-child(2) h3': 'Blue Nile Velvet', '.collection-card:nth-child(2) small': 'Feature rooms · Hospitality',
      '.collection-card:nth-child(3) .collection-card-copy p': 'LALIBELA TEXTURES', '.collection-card:nth-child(3) h3': 'Silver Bouclé', '.collection-card:nth-child(3) small': 'Bedrooms · Offices',
      '.collection-all > span': 'THE COMPLETE EDIT', '.collection-all strong': 'Twenty fabrics.<br><em>One considered collection.</em>', '.collection-all > p': 'Choose a favourite, note its Habiba code and call us for current availability and a made-to-measure price.', '.collection-all > b': 'View all 20 fabrics <i>→</i>',
      '.promise-copy .section-tag': 'THE HABIBA DIFFERENCE', '.promise h2': 'Made slowly.<br><em>Lived with daily.</em>',
      '.promise-photo-note': 'RESIDENTIAL DETAIL · HABIBA INSTALLATION',
      '.promise-copy > p:not(.section-tag)': 'Every panel is cut and finished by hand in our local workroom. We obsess over every fold, hem and heading, so the result feels effortless in your space.',
      '.stats div:nth-child(1) span': 'curated fabrics', '.stats div:nth-child(2) span': 'project sectors', '.stats div:nth-child(3) span': 'accountable team', '.arrow-link': 'Meet our makers <span>↗</span>',
      ...
      '.consult-copy .section-tag': 'YOUR WINDOWS, REIMAGINED', '.consultation h2': 'Let’s make<br><em>something beautiful.</em>', '.consult-copy > p:not(.section-tag)': 'Book a complimentary in-home consultation. We’ll bring the fabrics and ideas.',
      ...
      '.social-strip .section-tag': 'FOLLOW THE ATELIER', '.social-strip h2': 'See what we’re<br><em>making next.</em>',
      'footer > p': 'Made-to-measure curtains.', 'footer div a:nth-child(5)': 'Contact', 'footer div a:nth-child(6)': 'Back to top ↑',
  ...
  am: {
    ...
    text: {
      ...
      '.collection-card:nth-child(1) .collection-card-copy p': 'ቅርሳዊ ጥለቶች', '.collection-card:nth-child(1) h3': 'ቅርስ አሸዋ', '.collection-card:nth-child(1) small': 'ልዩ ሳሎን · ሆቴል',
      '.collection-card:nth-child(2) .collection-card-copy p': 'ዓባይ ሰማያዊ', '.collection-card:nth-child(2) h3': 'ዓባይ ሰማያዊ ቬልቬት', '.collection-card:nth-child(2) small': 'ልዩ ክፍል · ሆቴል',
      '.collection-card:nth-child(3) .collection-card-copy p': 'የላሊበላ ሸካራነቶች', '.collection-card:nth-child(3) h3': 'የብር ቡክሌ', '.collection-card:nth-child(3) small': 'መኝታ ቤት · ቢሮ',
      '.collection-all > span': 'ሙሉ የጨርቅ ምርጫ', '.collection-all strong': 'ሃያ ጨርቆች።<br><em>በጥንቃቄ የተመረጠ አንድ ስብስብ።</em>', '.collection-all > p': 'የወደዱትን ጨርቅና የሀቢባ ኮዱን ይምረጡ፤ የክምችት መረጃና በልክ የተዘጋጀ ዋጋ ለማግኘት ይደውሉልን።', '.collection-all > b': 'ሁሉንም 20 ጨርቆች ይመልከቱ <i>→</i>',
      '.promise-copy .section-tag': 'የሀቢባ ልዩነት', '.promise h2': 'በጥንቃቄ እንሰራዋለን።<br><em>በየቀኑ ይወዱታል።</em>',
      '.promise-photo-note': 'የመኖሪያ ቤት ዝርዝር · የሀቢባ ገጠማ',
      '.promise-copy > p:not(.section-tag)': 'እያንዳንዱን መጋረጃ በልክ ቆርጠን፣ በጥንቃቄ ሰፍተን እናጠናቅቃለን። እጥፋቱ፣ ርዝመቱና አሰቃቀሉ በቦታዎ ላይ ተፈጥሯዊና የተሟላ እንዲታይ ለዝርዝሩ ሁሉ ትኩረት እንሰጣለን።',
      '.stats div:nth-child(1) span': 'የተመረጡ ጨርቆች', '.stats div:nth-child(2) span': 'የምንሰራባቸው ዘርፎች', '.stats div:nth-child(3) span': 'አንድ ኃላፊ ቡድን', '.arrow-link': 'ባለሙያዎቻችንን ያግኙ <span>↗</span>',
      ...
      '.consult-copy .section-tag': 'መስኮትዎን በአዲስ ይዩ', '.consultation h2': 'ለቤትዎ የሚመጥን ውበት<br><em>አብረን እንፍጠር።</em>', '.consult-copy > p:not(.section-tag)': 'ነፃ የቤት ውስጥ ምክክር ይያዙ። ጨርቆቹን፣ ምርጫዎቹንና ሙያዊ ምክራችንን ይዘን ወደ እርስዎ እንመጣለን።',
      ...
      '.social-strip .section-tag': 'የሀቢባን አዳዲስ ስራዎች ይከታተሉ', '.social-strip h2': 'ቀጣዩን የሀቢባ ስራ<br><em>ይመልከቱ።</em>',
      'footer > p': 'በልክ የሚሰሩ መጋረጃዎች።', 'footer div a:nth-child(5)': 'ያግኙን', 'footer div a:nth-child(6)': 'ወደ ላይ ↑',
